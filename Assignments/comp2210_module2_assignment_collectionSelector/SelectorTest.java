...
public class SelectorTest {
   ...
   @Test public void kminDoubles3() {
      List<Integer> d = Arrays.asList(-4,-4,-4,-4,-4,4);
      Integer actual = Selector.<Integer>kmin(d, 2, ascendingInteger);
      Integer expected = -4;
      Assert.assertEquals(expected, actual);
   }
   
   @Test public void kmaxTest1() {
      List<Integer> d = Arrays.asList(-4,-4);
      Integer actual = Selector.<Integer>kmin(d, 2, ascendingInteger);
      Integer expected = -4;
      Assert.assertEquals(expected, actual);
   }
